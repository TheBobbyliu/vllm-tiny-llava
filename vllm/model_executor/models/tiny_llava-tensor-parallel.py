...
class TinyLlavaForConditionalGeneration(nn.Module):
    ...
    def extract_visual_features(
        ...
        if len(_pixel_values) < 1:
            ...
            selected_image_feature = self.vision_tower(_pixel_values, input_metadata)
    ...
    def forward(
        ...
        input_metadata_vision: InputMetadata = None,
        image_features: Optional[List[torch.Tensor]] = None,
            ...
            if input_ids.shape[1] != 1:
                ...
                if pixel_values is not None:
                    ...
                    image_features = self.extract_visual_features(
                        input_ids, pixel_values, image_features, input_metadata_vision)
    ...
    def load_weights(self,
        ...
        for name, loaded_weight in hf_model_weights_iterator(
            ...
            if name.startswith('multi_modal_projector'):  # load vision model weights
                # name = name[6:]  # remove "model." prefix
